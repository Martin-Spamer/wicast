...
public class MultiCastRelay {
    ...
    public class MultiCastSender extends java.lang.Thread {
         ...
         * using either a DatagramSocket or a
         * MulticastSocket. What makes it multicast is the address that is in
         * the datagram. If the address is a
         * multicast address, the datagram will reach the multicast members in
         * the group. You only need to use
